...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TicketingProjectException.class) //whenever exception happens to this class, execute this code.
    ...
    @ExceptionHandler(AccessDeniedException.class) //if any exception happens belongs to AccessDeniedException class, execute this code;
    ...
    public ResponseEntity<ResponseWrapper> genericException(Throwable e, HandlerMethod handlerMethod) {
        ...
        if (defaultMessage.isPresent() && !ObjectUtils.isEmpty(defaultMessage.get().getMessage())) { //if we have defaultMessage imply we the method is annotated with my default annotation.
