...
/*
Just remember we put one Swagger configuration file to create swagger documentation
for my application, including Oath2
 */
...
public class SwaggerConfig {
    ...
    private OAuthFlows createOAuthFlows() { //In this method we chose authorisation grant type.
